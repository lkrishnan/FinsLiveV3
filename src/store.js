...
export default new Vuex.Store( {
	state: {
		...
		gauge_info: null,
		ws: {
			fins: "https://finslive.mecklenburgcountync.gov/api/",
			...
			alarm: "https://finslive.mecklenburgcountync.gov/api/alarm",
		...
		overlays: [
			...
			{ label: "Storm Impacted Buildings", value: "rarrbldg", source: "rarrbldg", switch: false },
			{ label: "Storm Impacted Stream Crossings", value: "rarrstrmxing", source: "rarrstrmxing", switch: false },
			{ label: "Storm Impacted Roads", value: "rarrroad", source: "rarrroad", switch: false },
