...
export default new Vuex.Store( {
	state: {
		...
		overlays: [
			...
			{ label: "Now Event RI", value: "noweventri", source: "noweventri", switch: false },
			{ label: "Now Flood Indundation", value: "nowinund", source: "nowinund", switch: false },
			{ label: "Now Forcast Flood Indundation", value: "nowforecastinund", source: "nowforecastinund", switch: false },
